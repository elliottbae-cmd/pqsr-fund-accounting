...
LEASES = {
    "beavercreek": {
        ...
        "initial_term_months": 240,
        "lease_expiration_date": date(2043, 10, 31),
        "renewal_options": 4,
        ...
        "rent_schedule": [
            ...
            {"period": "Renewal 1: Month 241 - Month 300", "start_month": 241, "end_month": 300,
             "annual_rent": 256607.84, "monthly_rent": 21383.99},
            {"period": "Renewal 2: Month 301 - Month 360", "start_month": 301, "end_month": 360,
             "annual_rent": 275853.43, "monthly_rent": 22987.79},
            {"period": "Renewal 3: Month 361 - Month 420", "start_month": 361, "end_month": 420,
             "annual_rent": 296542.44, "monthly_rent": 24711.87},
            {"period": "Renewal 4: Month 421 - Month 480", "start_month": 421, "end_month": 480,
    ...
    "fairfield": {
        ...
        "initial_term_years": 20,
        "initial_term_months": 240,
        "lease_expiration_date": date(2044, 2, 28),
        "renewal_options": 4,
        "renewal_term_years": 5,
        "renewal_notice_months": 6,
        "escalation_rate": 0.075,
    ...
    "gallup": {
        ...
        "initial_term_years": 20,
        "initial_term_months": 240,
        "lease_expiration_date": date(2043, 4, 30),
        "renewal_options": 4,
        "renewal_term_years": 5,
        "renewal_notice_months": 6,
...
def generate_full_rent_schedule(lease_key):
    ...
    # Generate through all periods including renewals (480 months)
    max_month = max(p["end_month"] for p in lease["rent_schedule"])
